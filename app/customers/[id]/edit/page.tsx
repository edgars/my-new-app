        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-1.5">
                <label htmlFor="addr1" className="text-sm font-medium">Address Line 1</label>
                <Input id="addr1" type="text" placeholder="Enter address line 1" {...register("addr1")} />
                {errors.addr1 && <p className="text-sm text-destructive">{String(errors.addr1?.message ?? "")}</p>}
              </div>
              <div className="space-y-1.5">
                <label htmlFor="addr2" className="text-sm font-medium">Address Line 2</label>
                <Input id="addr2" type="text" placeholder="Enter address line 2" {...register("addr2")} />
              ...
              <div className="space-y-1.5">
                ...
                <Input id="lastinvoicedate" type="date" {...register("lastinvoicedate")} />
