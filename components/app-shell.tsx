...
import { Menu, PanelLeftClose, User, LogOut, UserCircle, LayoutGrid } from 'lucide-react'
...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex min-h-screen">
      ...
      {/* Main column */}
      <div className={cn('flex flex-1 flex-col transition-[padding] duration-200', collapsed ? 'md:pl-16' : 'md:pl-60')}>
