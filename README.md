...
- **ProgramaSocials**
- **ProgramaSocialGrpFaixaCalculos**
- **ProgramaSocialGrpParamRegionals**
- **Auditorias**
- **Beneficiarios**
- **BeneficiarioGrpDependentes**
- **Pagamentos**
- **PagamentoGrpDescontos**
...
- Screens (frontend): nextjs
- Brains (backend): nextjs + prisma
