async function ordersCalcFields(orderId: string) {
  ...
  // and that the resulting TaxTotal and AmountDue should be written back to the DB
  // rather than computed on-the-fly at read time. Also confirm rounding/precision rules.
